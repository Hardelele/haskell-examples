...
intersections line_point1 line_point2 circle_center radius
 ...
 | discriminant < 0  = "Have no intersections!"
 | discriminant == 0 = " X = " ++ show result_x_d0 ++ "; Y = " ++ show result_y_d0
 | discriminant > 0  = " X1 = " ++ show result_x1 ++ "; Y1 = " ++ show result_y1 ++ "; X2 = " ++ show result_x2 ++ "; Y2 = " ++ show result_y2
  where
   circle_center_x = head circle_center
   circle_center_y = last circle_center
   line_point1_x   = head line_point1
